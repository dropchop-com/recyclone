...
import static com.dropchop.recyclone.model.api.marker.Constants.Implementation.RECYCLONE_JPA_DEFAULT2;

@Deprecated(since = "Replaced with abstract common service implementation. Kept for reference", forRemoval = true)
@Slf4j
@Getter
@ApplicationScoped
@RecycloneType("RECYCLONE_DEPRECATED")
public class SecurityLoadingServiceOld implements com.dropchop.recyclone.service.api.security.SecurityLoadingService {
