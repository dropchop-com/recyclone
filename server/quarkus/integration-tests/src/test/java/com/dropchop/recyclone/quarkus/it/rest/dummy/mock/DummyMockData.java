...
public class DummyMockData {
  ...
  public List<Dummy> createMockDummies() {
    ...
    dummies.add(createDummy("sad15s1a21sa21a51a","Dummy 1", "Description 1", "en", ZonedDateTime.now(),
    ...
    dummies.add(createDummy("asdlasdadsa4dsds4d","Dummy 2", "Description 2", "fr", ZonedDateTime.now(),
    ...
    dummies.add(createDummy("4d5as45s1ds4d5ss8sd6s","Dummy 3", "Beschreibung 3", "de", ZonedDateTime.now(),
    ...
    dummies.add(createDummy("48s4d51sa5s45s121s","Dummy 4", "Descripción 4", "es", ZonedDateTime.now(),
    ...
    dummies.add(createDummy("asdasdsadassa1s11s1ss","Dummy 5", "Descrizione 5", "it", ZonedDateTime.now(),
    ...
    dummies.add(createDummy("sdas1s1s1s1s11s1s1s1s1","Dummy 6", "Descrição 6", "pt", ZonedDateTime.now(),
    ...
    dummies.add(createDummy("8s1s5s45aw1g45f4g","Dummy 7", "Описание 7", "ru", ZonedDateTime.now(),
    ...
    dummies.add(createDummy("wh48u2f4v8h4t2r6","Dummy 8", "描述8", "zh", ZonedDateTime.now(),
