...
public class EventsResourceTest {
  ...
  public void create() {
    ...
    List<Event> events = given()
      ...
      .body(List.of(event))
      .when()
      .post(EVENTS_ENDPOINT + "?modify_policy=wait")
      .then()
      .statusCode(200)
      .extract()
  ...
  public void get() {
    List<Event> events = given()
      ...
      .and()
      .when()
      .get(EVENTS_ENDPOINT + "/" + EVENT_ID + "?c_level=5")
      .then()
      .statusCode(200)
      .extract()
      .body().jsonPath().getList(".", Event.class);
  ...
  public void delete() throws IOException {
    ...
    List<Event> events = given()
      ...
      .body(List.of(event))
      .when()
      .delete(EVENTS_ENDPOINT + "?modify_policy=wait")
      .then()
      .statusCode(200)
      .extract()
      .body().jsonPath().getList(".", Event.class);
  ...
  public void deleteMultiple() {
    ...
    given()
        ...
        .body(params)
        .when()
        .delete(EVENTS_ENDPOINT + "/deleteByQuery?modify_policy=wait")
        .then()
        .statusCode(200);
  }
