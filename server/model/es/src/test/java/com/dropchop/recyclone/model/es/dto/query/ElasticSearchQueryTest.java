...
public class ElasticSearchQueryTest {
  ...
  public void testTermsQueryWithMultipleValues() {
    ...
    QueryFilter<List<String>> filter = new QueryFilter<>("tags", QueryFilter.Operation.IN, values, QueryFilter.LogicalOperator.AND);
    ElasticSearchQuery query = new ElasticSearchQuery(List.of(filter), List.of());
    assertEquals(expectedJson, query.buildJson());
  }
  ...
  public void complexQueryWithMultipleFiltersAndAggregations() {
    ...
    QueryFilter<List<Number>> priceFilter = new QueryFilter<>("price", QueryFilter.Operation.RANGE, List.of(100, 500), QueryFilter.LogicalOperator.AND);
