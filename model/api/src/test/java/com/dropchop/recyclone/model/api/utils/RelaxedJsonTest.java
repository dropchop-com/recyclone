...
class RelaxedJsonTest {
  ...
  @Test
  void parse0() throws ParseException {
    ...
    RelaxedJson.parse(str);
    str = "{color: '#FDFDFD', miki: 12.3, date: '2022-07-12', arr:[1, 2, 3, 4]}";
  ...
  void parse1() throws ParseException {
    ...
    str = "{bool: [true, false]}";
    root = RelaxedJson.parse(str);
    assertEquals(List.of(Boolean.TRUE, Boolean.FALSE), root.get("bool"));

    str = "{color: '#FDFDFD', miki: 12.3, date: '2022-07-12', arr:[1, 2, 3, 4], bool : [ true, \t\nfalse ]}";
    root = RelaxedJson.parse(str);
    assertEquals(Iso8601.fromIso("2022-07-12"), root.get("date"));
    assertEquals(new BigDecimal("12.3"), root.get("miki"));
    assertEquals(List.of(Boolean.TRUE, Boolean.FALSE), root.get("bool"));
  ...
  @Test
  void parseUnnamedAttributes0() throws ParseException {
  ...
  @Test
  void parseUnnamedAttributes1() throws ParseException {
  ...
  @Test
  void parseUnnamedAttributes2() throws ParseException {
  ...
  @Test
  void parseUnnamedAttributes3() throws ParseException {
