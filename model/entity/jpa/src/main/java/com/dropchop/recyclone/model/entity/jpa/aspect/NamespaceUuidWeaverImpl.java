...
public class NamespaceUuidWeaverImpl implements NamespaceUuidWeaver {
  ...
  @After(value = "set(String com.dropchop.recyclone.model.entity..*name) " +
    "&& this(com.dropchop.recyclone.model.api.marker.HasName) && this(com.dropchop.recyclone.model.api.marker.HasUuidV3) " +
  ...
  @After(value = "set(String com.dropchop.recyclone.model.entity..*code) " +
    "&& this(com.dropchop.recyclone.model.api.marker.HasCode) && this(com.dropchop.recyclone.model.api.marker.HasUuidV3) " +
