...
public class Shared extends NamedTag
  implements com.dropchop.recyclone.base.api.model.tagging.Shared<Tag, TitleDescriptionTranslation> {

  public Shared(@NonNull String name) {
    super(name);
  }
}
