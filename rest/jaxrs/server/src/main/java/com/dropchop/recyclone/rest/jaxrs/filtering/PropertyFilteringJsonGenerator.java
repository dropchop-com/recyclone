...
public class PropertyFilteringJsonGenerator extends JsonGeneratorDelegate {
  ...
  public PropertyFilteringJsonGenerator(JsonGenerator generator, Integer maxLevel, String contentDetail, PropertyFilter filter) {
    super(generator, false);
    this.itemFilter = filter;
    this.filterContext = PropertyFilteringTokenContext.createRootContext(filter, null, maxLevel, contentDetail);
  }

  @Override
  public void writeStartArray(Object forValue, int size) throws IOException {
    if (itemFilter == null) {
      filterContext = filterContext.createChildArrayContext(null, forValue, false);
    } else {
      filterContext = filterContext.createChildArrayContext(itemFilter, forValue, true);
      if (forValue == null) {
        if (size < 0) {
  ...
  public void writeStartObject(Object forValue, int size) throws IOException {
    if (itemFilter == null) {
      filterContext = filterContext.createChildObjectContext(itemFilter, forValue, false);
    } else {
      filterContext = filterContext.createChildObjectContext(itemFilter, forValue, true);
